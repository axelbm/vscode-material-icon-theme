...
export const folderIcons: FolderTheme[] = [
    {
        ...
        icons: [
            ...
            {
                name: 'folder-views',
                folderNames: ['view', 'views', 'screen', 'screens', 'page', 'pages', 'html', 'vue', 'vues']
            },
            ...
            { name: 'folder-aurelia', folderNames: ['aurelia_project'] },
            {
                ...
                folderNames: ['resource', 'resources', 'res', 'asset', 'assets', 'static', 'ressource', 'ressources']
            },
            { name: 'folder-lib', folderNames: ['lib', 'libs', 'library', 'libraries', 'vendor', 'vendors', 'third-party'] },
            { name: 'folder-theme', folderNames: ['themes', 'theme', 'color', 'colors', 'design', 'designs', 'couleur', 'couleurs'] },
            ...
            { name: 'folder-class', folderNames: ['class', 'classes', 'model', 'models', 'modele', 'modeles'] },
            ...
            { name: 'folder-controller', folderNames: ['controller', 'controllers', 'controleur', 'controleurs', 'service', 'services', 'provider', 'providers'] },
            { name: 'folder-ansible', folderNames: ['ansible'] },
            { name: 'folder-server', folderNames: ['server', 'servers', 'serveur', 'serveurs', 'backend'] },
            ...
            { name: 'folder-tools', folderNames: ['tools', 'outils'] },
            ...
            { name: 'folder-examples', folderNames: ['example', 'examples', 'exemple', 'exemples', 'sample', 'samples', 'demo', 'demos'] },
            { name: 'folder-environment', folderNames: ['.env', '.environment', 'environment', 'environments'] },
            { name: 'folder-functions', folderNames: ['function', 'functions', 'fonction', 'fonctions', 'lambda', 'lambdas'] },
            { name: 'folder-generator', folderNames: ['generator', 'generators', 'generateur', 'generateurs', 'generated', 'cfn-gen', 'gen', 'gens', 'auto'] },
            ...
            { name: 'folder-layout', folderNames: ['layout', 'layouts', 'disposition', 'dispositions'] },
            ...
            { name: 'folder-packages', folderNames: ['package', 'packages', 'paquet', 'paquets'] },
            { name: 'folder-shared', folderNames: ['shared', 'partagé'] },
            ...
            { name: 'folder-rules', folderNames: ['rule', 'rules', 'validation', 'validations', 'validator', 'validators', 'regle', 'regles', 'validateur', 'validateurs'] },
